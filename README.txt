...
- Before launch the proyect is necesary create the database.
- The credentials for database are in the lecture of L01.
- There proyect is editig by C1.031 group.
