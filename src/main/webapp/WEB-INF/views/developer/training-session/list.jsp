...
<acme:list>
	...
	<acme:list-column code="developer.training-session.list.label.startPeriod;" path="startPeriod;" width="10%"/>
	<acme:list-column code="developer.training-session.list.label.endPeriod" path="endPeriod" width="10%"/>
	...
	<acme:list-column code="developer.training-session.list.label.published" path="draftMode"/>
