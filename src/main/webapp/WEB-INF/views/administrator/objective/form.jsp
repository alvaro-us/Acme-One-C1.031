...
<acme:form> 
	...
	<acme:input-moment code="administrator.objective.form.label.durationStart" path="durationStart"/>
	<acme:input-moment code="administrator.objective.form.label.durationEnd" path="durationEnd"/>
