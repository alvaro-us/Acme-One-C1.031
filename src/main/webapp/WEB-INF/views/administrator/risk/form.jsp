...
<acme:form>
	<acme:input-textbox code="administrator.risk.form.label.reference" path="reference" placeholder="^R-\\d{3}$"/>
	...
	<acme:input-textbox code="administrator.risk.form.label.project" path="project"/>
